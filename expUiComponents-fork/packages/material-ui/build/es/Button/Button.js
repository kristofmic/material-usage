...
function Button(props) {
  const {
    ...
    variant
        ...
        other = _objectWithoutProperties(props, ["children", "classes", "className", "color", "disabled", "disableFocusRipple", "focusVisibleClassName", "fullWidth", "loading", "mini", "size", "variant"]);
  ...
  }, other), React.createElement(Transition, {
    in: loading,
    timeout: duration
  }, state => React.createElement(React.Fragment, null, loading && state === 'entered' && React.createElement(CircularProgress, {
    className: classNames(classes.progress),
    disabled: loading,
    size: 20
  }), React.createElement("span", {
    className: classNames(classes.children, classes[`children-${state}`])
  }, React.createElement("span", {
